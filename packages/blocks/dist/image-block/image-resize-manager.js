...
import { getClosestBlockElementByElement, getModelByElement, isEdgelessPage, } from '../_common/utils/query.js';
...
export class ImageResizeManager {
    ...
    onStart(e) {
        ...
        this._activeComponent = getClosestBlockElementByElement(eventTarget);
