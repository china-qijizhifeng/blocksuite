...
export declare function fetchImageBlob(block: ImageBlockComponent): Promise<void>;
export declare function downloadImageBlob(block: ImageBlockComponent): Promise<void>;
export declare function resetImageSize(block: ImageBlockComponent): Promise<void>;
export declare function copyImageBlob(blockElement: ImageBlockComponent): Promise<void>;
 ...
 */
export declare function turnImageIntoCardView(block: ImageBlockComponent): Promise<void>;
