...
export declare const richTextColumnType: {
    ...
    modelConfig: <CellData, ColumnData extends Record<string, unknown> = Record<string, never>>(ops: {
        ...
        type: (data: ColumnData) => import("../../../database-block/data-view/logical/typesystem.js").TType;
        ...
        type: "rich-text";
        model: import("../../../database-block/data-view/column/column-config.js").ColumnConfig<"rich-text", ColumnData, CellData>;
        create: (name: string, data?: ColumnData | undefined) => {
            type: string;
            name: string;
            statCalcOp: import("../../../database-block/data-view/index.js").StatCalcOpType;
            data: ColumnData;
        };
        addConvert: <ToCellName extends keyof ColumnConfigMap>(to: ToCellName, convert: (column: ColumnData, cells: (CellData | undefined)[]) => {
            column: import("../../../database-block/data-view/column/manager.js").GetColumnDataFromConfig<ColumnConfigMap[ToCellName]>;
            cells: (import("../../../database-block/data-view/column/manager.js").GetCellDataFromConfig<ColumnConfigMap[ToCellName]> | undefined)[];
        }) => void;
        renderConfig: (renderer: Omit<import("../../../database-block/data-view/column/renderer.js").Renderer<ColumnData, CellData>, "type">) => import("../../../database-block/data-view/column/column-config.js").ColumnMeta<"rich-text", CellData, ColumnData>;
    };
};
declare global {
...
export declare const richTextColumnModelConfig: {
    type: "rich-text";
    model: import("../../../database-block/data-view/column/column-config.js").ColumnConfig<"rich-text", Record<string, never>, RichTextCellType>;
    ...
    renderConfig: (renderer: Omit<import("../../../database-block/data-view/column/renderer.js").Renderer<Record<string, never>, RichTextCellType>, "type">) => import("../../../database-block/data-view/column/column-config.js").ColumnMeta<"rich-text", RichTextCellType, Record<string, never>>;
};
