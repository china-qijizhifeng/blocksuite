...
import { DatabaseSelection, DataView, defineUniComponent, renderUniLit, widgetPresets, } from '../database-block/data-view/index.js';
        ...
        ${this.dataView.render({
                ...
                detailPanelConfig: {
                    openDetailPanel: peekViewService
                        ? async (target, template) => peekViewService.peek(target, template)
                        : undefined,
