...
import { EdgelessEditorBlockSpecs, PreviewEdgelessEditorBlockSpecs, } from './edgeless-specs.js';
...
SpecProvider.getInstance().addSpec('edgeless:preview', PreviewEdgelessEditorBlockSpecs);
// specs preset
...
export { 
// common
AttachmentBlockSpec, BookmarkBlockSpec, CodeBlockSpec, DatabaseBlockSpec, DataViewBlockSpec, DividerBlockSpec, EmbedFigmaBlockSpec, EmbedGithubBlockSpec, EmbedHtmlBlockSpec, EmbedLinkedDocBlockSpec, EmbedLoomBlockSpec, EmbedSyncedDocBlockSpec, EmbedYoutubeBlockSpec, ImageBlockSpec, ListBlockSpec, NoteBlockSpec, ParagraphBlockSpec, 
// edgeless
EdgelessRootBlockSpec, EdgelessSurfaceBlockSpec, EdgelessSurfaceRefBlockSpec, FrameBlockSpec, EdgelessTextBlockSpec, 
// page
PageRootBlockSpec, PageSurfaceBlockSpec, PageSurfaceRefBlockSpec, };
