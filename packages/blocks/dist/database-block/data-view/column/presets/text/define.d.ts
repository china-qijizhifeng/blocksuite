export declare const textColumnType: {
    type: "text";
    modelConfig: <CellData, ColumnData extends Record<string, unknown> = Record<string, never>>(ops: {
        ...
        type: "text";
        model: import("../../column-config.js").ColumnConfig<"text", ColumnData, CellData>;
        ...
        renderConfig: (renderer: Omit<import("../../renderer.js").Renderer<ColumnData, CellData>, "type">) => import("../../column-config.js").ColumnMeta<"text", CellData, ColumnData>;
    };
};
declare global {
...
export declare const textColumnModelConfig: {
    type: "text";
    model: import("../../column-config.js").ColumnConfig<"text", Record<string, never>, string>;
    ...
    renderConfig: (renderer: Omit<import("../../renderer.js").Renderer<Record<string, never>, string>, "type">) => import("../../column-config.js").ColumnMeta<"text", string, Record<string, never>>;
};
