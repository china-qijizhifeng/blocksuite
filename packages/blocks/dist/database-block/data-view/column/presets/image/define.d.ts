export declare const imageColumnType: {
    type: "image";
    modelConfig: <CellData, ColumnData extends Record<string, unknown> = Record<string, never>>(ops: {
        ...
        type: "image";
        model: import("../../column-config.js").ColumnConfig<"image", ColumnData, CellData>;
        ...
        renderConfig: (renderer: Omit<import("../../renderer.js").Renderer<ColumnData, CellData>, "type">) => import("../../column-config.js").ColumnMeta<"image", CellData, ColumnData>;
    };
};
declare global {
...
export declare const imageColumnModelConfig: {
    type: "image";
    model: import("../../column-config.js").ColumnConfig<"image", Record<string, never>, string>;
    ...
    addConvert: <ToCellName extends keyof ColumnConfigMap>(to: ToCellName, convert: (column: Record<string, never>, cells: (string | undefined)[]) => {
        column: import("../../manager.js").GetColumnDataFromConfig<ColumnConfigMap[ToCellName]>;
        cells: (import("../../manager.js").GetCellDataFromConfig<ColumnConfigMap[ToCellName]> | undefined)[];
    }) => void;
    renderConfig: (renderer: Omit<import("../../renderer.js").Renderer<Record<string, never>, string>, "type">) => import("../../column-config.js").ColumnMeta<"image", string, Record<string, never>>;
};
