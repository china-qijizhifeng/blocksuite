export declare const linkColumnType: {
    type: "link";
    modelConfig: <CellData, ColumnData extends Record<string, unknown> = Record<string, never>>(ops: {
        ...
        type: "link";
        model: import("../../column-config.js").ColumnConfig<"link", ColumnData, CellData>;
        ...
        renderConfig: (renderer: Omit<import("../../renderer.js").Renderer<ColumnData, CellData>, "type">) => import("../../column-config.js").ColumnMeta<"link", CellData, ColumnData>;
    };
};
declare global {
...
export declare const linkColumnModelConfig: {
    type: "link";
    model: import("../../column-config.js").ColumnConfig<"link", Record<string, never>, string>;
    ...
    renderConfig: (renderer: Omit<import("../../renderer.js").Renderer<Record<string, never>, string>, "type">) => import("../../column-config.js").ColumnMeta<"link", string, Record<string, never>>;
};
