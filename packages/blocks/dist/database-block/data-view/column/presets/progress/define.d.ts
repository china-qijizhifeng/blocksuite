export declare const progressColumnType: {
    type: "progress";
    modelConfig: <CellData, ColumnData extends Record<string, unknown> = Record<string, never>>(ops: {
        ...
        type: "progress";
        model: import("../../column-config.js").ColumnConfig<"progress", ColumnData, CellData>;
        ...
        renderConfig: (renderer: Omit<import("../../renderer.js").Renderer<ColumnData, CellData>, "type">) => import("../../column-config.js").ColumnMeta<"progress", CellData, ColumnData>;
    };
};
declare global {
...
export declare const progressColumnModelConfig: {
    type: "progress";
    model: import("../../column-config.js").ColumnConfig<"progress", Record<string, never>, number>;
    ...
    renderConfig: (renderer: Omit<import("../../renderer.js").Renderer<Record<string, never>, number>, "type">) => import("../../column-config.js").ColumnMeta<"progress", number, Record<string, never>>;
};
