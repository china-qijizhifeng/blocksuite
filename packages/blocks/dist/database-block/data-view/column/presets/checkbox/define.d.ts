export declare const checkboxColumnType: {
    type: "checkbox";
    modelConfig: <CellData, ColumnData extends Record<string, unknown> = Record<string, never>>(ops: {
        ...
        type: "checkbox";
        model: import("../../column-config.js").ColumnConfig<"checkbox", ColumnData, CellData>;
        ...
        renderConfig: (renderer: Omit<import("../../renderer.js").Renderer<ColumnData, CellData>, "type">) => import("../../column-config.js").ColumnMeta<"checkbox", CellData, ColumnData>;
    };
};
declare global {
...
export declare const checkboxColumnModelConfig: {
    type: "checkbox";
    model: import("../../column-config.js").ColumnConfig<"checkbox", Record<string, never>, boolean>;
    ...
    addConvert: <ToCellName extends keyof ColumnConfigMap>(to: ToCellName, convert: (column: Record<string, never>, cells: (boolean | undefined)[]) => {
        column: import("../../manager.js").GetColumnDataFromConfig<ColumnConfigMap[ToCellName]>;
        cells: (import("../../manager.js").GetCellDataFromConfig<ColumnConfigMap[ToCellName]> | undefined)[];
    }) => void;
    renderConfig: (renderer: Omit<import("../../renderer.js").Renderer<Record<string, never>, boolean>, "type">) => import("../../column-config.js").ColumnMeta<"checkbox", boolean, Record<string, never>>;
};
