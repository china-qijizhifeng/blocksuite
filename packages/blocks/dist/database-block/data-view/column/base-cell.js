...
let BaseCellRenderer = (() => {
    ...
    return class BaseCellRenderer extends _classSuper {
        ...
        #column_accessor_storage = (__runInitializers(this, _view_extraInitializers), __runInitializers(this, _column_initializers, void 0));
        get column() { return this.#column_accessor_storage; }
        set column(value) { this.#column_accessor_storage = value; }
        #rowId_accessor_storage = (__runInitializers(this, _column_extraInitializers), __runInitializers(this, _rowId_initializers, void 0));
        get rowId() { return this.#rowId_accessor_storage; }
        set rowId(value) { this.#rowId_accessor_storage = value; }
        #isEditing_accessor_storage = (__runInitializers(this, _rowId_extraInitializers), __runInitializers(this, _isEditing_initializers, void 0));
        get isEditing() { return this.#isEditing_accessor_storage; }
        set isEditing(value) { this.#isEditing_accessor_storage = value; }
        #selectCurrentCell_accessor_storage = (__runInitializers(this, _isEditing_extraInitializers), __runInitializers(this, _selectCurrentCell_initializers, void 0));
        ...
        connectedCallback() {
            ...
            this._disposables.add(this.column.onCellUpdate(this.rowId, () => {
