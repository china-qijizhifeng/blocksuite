...
export interface GroupRenderProps<Data extends NonNullable<unknown> = NonNullable<unknown>, Value = unknown> {
    data: Data;
...
export type GroupByConfig = {
    ...
    valuesGroup: (value: unknown, type: TType) => {
        key: string;
        value: unknown;
    }[];
...
export declare const groupByMatcher: Matcher<GroupByConfig, TType>;
