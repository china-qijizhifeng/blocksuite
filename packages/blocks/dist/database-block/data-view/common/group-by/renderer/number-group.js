...
let NumberGroupView = (() => {
    let _classDecorators = [customElement('data-view-group-title-number-view')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = BaseGroup;
    var NumberGroupView = class extends _classSuper {
        ...
        static {
            ...
            NumberGroupView = _classThis = _classDescriptor.value;
  ...
  `; }
    ...
    return NumberGroupView = _classThis;
})();
export { NumberGroupView };
//# sourceMappingURL=number-group.js.map