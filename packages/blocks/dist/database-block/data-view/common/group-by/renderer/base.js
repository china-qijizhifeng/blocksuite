...
let BaseGroup = (() => {
    ...
    return class BaseGroup extends _classSuper {
        ...
        #updateData_accessor_storage = (__runInitializers(this, _data_extraInitializers), __runInitializers(this, _updateData_initializers, undefined));
        get updateData() { return this.#updateData_accessor_storage; }
        set updateData(value) { this.#updateData_accessor_storage = value; }
        #value_accessor_storage = (__runInitializers(this, _updateData_extraInitializers), __runInitializers(this, _value_initializers, void 0));
        get value() { return this.#value_accessor_storage; }
        set value(value) { this.#value_accessor_storage = value; }
        #updateValue_accessor_storage = (__runInitializers(this, _value_extraInitializers), __runInitializers(this, _updateValue_initializers, undefined));
        get updateValue() { return this.#updateValue_accessor_storage; }
        set updateValue(value) { this.#updateValue_accessor_storage = value; }
        #readonly_accessor_storage = (__runInitializers(this, _updateValue_extraInitializers), __runInitializers(this, _readonly_initializers, void 0));
