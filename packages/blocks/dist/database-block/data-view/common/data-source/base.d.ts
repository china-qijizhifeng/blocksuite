...
export interface DataSource {
    ...
    cellChangeRenderValue: (rowId: string, propertyId: string, value: unknown) => unknown;
...
export declare abstract class BaseDataSource implements DataSource {
    ...
    cellChangeRenderValue(rowId: string, propertyId: string, value: unknown): void;
    cellGetRenderValue(rowId: string, propertyId: string): unknown;
    ...
    onCellUpdate(_rowId: string, _propertyId: string, _callback: () => void): Disposable;
