...
import { DatabaseDuplicate, DatabaseInsertLeft, DatabaseInsertRight, DatabaseMoveLeft, DatabaseMoveRight, DeleteIcon, TextIcon, } from '../../../../../common/icons/index.js';
...
let DatabaseHeaderColumn = (() => {
    ...
    var DatabaseHeaderColumn = class extends _classSuper {
        ...
        constructor() {
            ...
            this.#column_accessor_storage = (__runInitializers(this, _tableViewManager_extraInitializers), __runInitializers(this, _column_initializers, void 0));
            ...
            this._columnsOffset = (__runInitializers(this, _grabStatus_extraInitializers), (header, _scale) => {
