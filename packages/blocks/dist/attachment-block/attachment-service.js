        ...
        this._fileDropOptions = {
            ...
            onDrop: async ({ files, targetModel, place, point }) => {
                ...
                if (targetModel && !matchFlavours(targetModel, ['affine:surface'])) {
                    await addSiblingAttachmentBlocks(this.host, attachmentFiles, this.maxFileSize, targetModel, place);
                }
        ...
        this._dragHandleOption = {
            ...
            onDragStart: ({ state, startDragging, anchorBlockPath, editorHost }) => {
                ...
                if (!isInSurface && (isDraggingByDragHandle || isDraggingByComponent)) {
                    ...
                    const attachmentPortal = blockComponent.closest('.edgeless-block-portal-attachment');
                    assertExists(attachmentPortal);
                    const dragPreviewEl = attachmentPortal.cloneNode();
