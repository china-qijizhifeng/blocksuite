...
import { BookmarkIcon, CaptionIcon, EditIcon, EmbedWebIcon, LinkIcon, MoreIcon, ViewIcon, } from '../../_common/icons/index.js';
...
export function AttachmentOptionsTemplate({ anchor, model, showCaption, downloadAttachment, abortController, ref: refOrCallback = createRef(), }) {
    let containerEl;
