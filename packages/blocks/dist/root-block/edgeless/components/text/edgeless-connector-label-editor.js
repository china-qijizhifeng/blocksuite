...
let EdgelessConnectorLabelEditor = (() => {
    ...
    var EdgelessConnectorLabelEditor = class extends _classSuper {
        ...
        constructor() {
            ...
            this.#connector_accessor_storage = (__runInitializers(this, _richText_extraInitializers), __runInitializers(this, _connector_initializers, void 0));
            ...
            this._updateLabelRect = (__runInitializers(this, _edgeless_extraInitializers), () => {
  ...
  `; }
        ...
        render() {
            ...
            const { labelOffset: { distance }, labelStyle: { fontFamily, fontSize, fontStyle, fontWeight, color, textAlign, }, labelConstraints: { hasMaxWidth, maxWidth }, } = connector;
