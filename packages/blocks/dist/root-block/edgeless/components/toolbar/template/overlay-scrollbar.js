...
import { on, once, requestConnectedFrame, } from '../../../../../_common/utils/event.js';
/**
...
let OverlayScrollbar = (() => {
    ...
    var OverlayScrollbar = class extends _classSuper {
        ...
        constructor() {
            ...
            this._disposable = (__runInitializers(this, __handle_extraInitializers), new DisposableGroup());
