...
import { requestConnectedFrame, stopPropagation, } from '../../../../../_common/utils/event.js';
...
let EdgelessTemplatePanel = (() => {
  ...
  `; }
        ...
        connectedCallback() {
            ...
            this._disposables.add(() => {
                if (this._currentCategory) {
                    this.edgeless.service.editPropsStore.setItem('templateCache', this._currentCategory);
                }
            });
        }
        firstUpdated() {
    ...
    `;
        ...
        constructor() {
            super(...arguments);
            this.#_currentCategory_accessor_storage = __runInitializers(this, __currentCategory_initializers, '');
            this.#_loadingTemplate_accessor_storage = (__runInitializers(this, __currentCategory_extraInitializers), __runInitializers(this, __loadingTemplate_initializers, null));
            ...
            this.#_loading_accessor_storage = (__runInitializers(this, __searchKeyword_extraInitializers), __runInitializers(this, __loading_initializers, false));
            this.#_categories_accessor_storage = (__runInitializers(this, __loading_extraInitializers), __runInitializers(this, __categories_initializers, []));
            this.#_templates_accessor_storage = (__runInitializers(this, __categories_extraInitializers), __runInitializers(this, __templates_initializers, []));
            this.#isDragging_accessor_storage = (__runInitializers(this, __templates_extraInitializers), __runInitializers(this, _isDragging_initializers, false));
            this._fetchJob = (__runInitializers(this, _isDragging_extraInitializers), null);
