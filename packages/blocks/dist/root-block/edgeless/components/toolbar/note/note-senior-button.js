...
let EdgelessNoteSeniorButton = (() => {
    ...
    let __noteBg_decorators;
    let __noteBg_initializers = [];
    let __noteBg_extraInitializers = [];
    ...
    var EdgelessNoteSeniorButton = class extends _classSuper {
        ...
        static {
            ...
            __noteBg_decorators = [state()];
            _childFlavour_decorators = [state()];
            _childType_decorators = [state()];
            _tip_decorators = [state()];
            __esDecorate(this, null, __noteBg_decorators, { kind: "accessor", name: "_noteBg", static: false, private: false, access: { has: obj => "_noteBg" in obj, get: obj => obj._noteBg, set: (obj, value) => { obj._noteBg = value; } }, metadata: _metadata }, __noteBg_initializers, __noteBg_extraInitializers);
  ...
  `; }
        #_noteBg_accessor_storage;
        get _noteBg() { return this.#_noteBg_accessor_storage; }
        set _noteBg(value) { this.#_noteBg_accessor_storage = value; }
    ...
    >
      ...
      >
        ...
        constructor() {
            ...
            this.#_noteBg_accessor_storage = __runInitializers(this, __noteBg_initializers, DEFAULT_NOTE_BACKGROUND_COLOR);
            this.type = (__runInitializers(this, __noteBg_extraInitializers), 'affine:note');
