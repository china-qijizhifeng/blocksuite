...
let EdgelessToolbar = (() => {
  ...
  `; }
        ...
        constructor(edgeless) {
            ...
            this.#toolbarContainer_accessor_storage = __runInitializers(this, _toolbarContainer_initializers, void 0);
            this.#containerWidth_accessor_storage = (__runInitializers(this, _toolbarContainer_extraInitializers), __runInitializers(this, _containerWidth_initializers, 1920));
            this.#presentSettingMenuShow_accessor_storage = (__runInitializers(this, _containerWidth_extraInitializers), __runInitializers(this, _presentSettingMenuShow_initializers, false));
            this.#presentFrameMenuShow_accessor_storage = (__runInitializers(this, _presentSettingMenuShow_extraInitializers), __runInitializers(this, _presentFrameMenuShow_initializers, false));
            this.#scrollSeniorToolIndex_accessor_storage = (__runInitializers(this, _presentFrameMenuShow_extraInitializers), __runInitializers(this, _scrollSeniorToolIndex_initializers, 0));
            this.#edgelessTool_accessor_storage = (__runInitializers(this, _scrollSeniorToolIndex_extraInitializers), __runInitializers(this, _edgelessTool_initializers, {
                type: localStorage.defaultTool ?? 'default',
            }));
            this.setEdgelessTool = (__runInitializers(this, _edgelessTool_extraInitializers), (edgelessTool) => {
    ...
    `;
        ...
        firstUpdated() {
            ...
            _disposables.add(this.edgeless.service.editPropsStore.slots.itemUpdated.on(({ key }) => {
