...
let EdgelessFrameOrderMenu = (() => {
  ...
  `; }
        #_curIndex_accessor_storage = __runInitializers(this, __curIndex_initializers, -1);
        get _curIndex() { return this.#_curIndex_accessor_storage; }
        set _curIndex(value) { this.#_curIndex_accessor_storage = value; }
        #embed_accessor_storage = (__runInitializers(this, __curIndex_extraInitializers), __runInitializers(this, _embed_initializers, false));
        get embed() { return this.#embed_accessor_storage; }
        set embed(value) { this.#embed_accessor_storage = value; }
        #_container_accessor_storage = (__runInitializers(this, _embed_extraInitializers), __runInitializers(this, __container_initializers, void 0));
        get _container() { return this.#_container_accessor_storage; }
        set _container(value) { this.#_container_accessor_storage = value; }
        #_indicatorLine_accessor_storage = (__runInitializers(this, __container_extraInitializers), __runInitializers(this, __indicatorLine_initializers, void 0));
        ...
        #_clone_accessor_storage = (__runInitializers(this, __indicatorLine_extraInitializers), __runInitializers(this, __clone_initializers, void 0));
        get _clone() { return this.#_clone_accessor_storage; }
        set _clone(value) { this.#_clone_accessor_storage = value; }
        #edgeless_accessor_storage = (__runInitializers(this, __clone_extraInitializers), __runInitializers(this, _edgeless_initializers, void 0));
