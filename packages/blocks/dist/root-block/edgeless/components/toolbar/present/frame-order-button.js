...
let EdgelessFrameOrderButton = (() => {
  ...
  `; }
    ...
    `;
        ...
        firstUpdated() {
            this._edgelessFrameOrderPopper = createButtonPopper(this._edgelessFrameOrderButton, this._edgelessFrameOrderMenu, ({ display }) => this.setPopperShow(display === 'show'), 22);
        }
        constructor() {
            super(...arguments);
            ...
            this._edgelessFrameOrderPopper = (__runInitializers(this, __edgelessFrameOrderMenu_extraInitializers), null);
