import { ConnectorCWithArrowIcon, ConnectorIcon, ConnectorLWithArrowIcon, ConnectorXWithArrowIcon, } from '../../../../../_common/icons/edgeless.js';
import { ConnectorMode } from '../../../../../surface-block/index.js';
export const buildConnectorDenseMenu = edgeless => {
    const prevMode = edgeless.service.editPropsStore.getLastProps('connector').mode ??
        ConnectorMode.Curve;
