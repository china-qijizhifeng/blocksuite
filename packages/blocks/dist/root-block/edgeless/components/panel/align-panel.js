...
import { TextAlignCenterIcon, TextAlignLeftIcon, TextAlignRightIcon, } from '../../../../_common/icons/index.js';
...
let EdgelessAlignPanel = (() => {
    let _classDecorators = [customElement('edgeless-align-panel')];
    ...
    var EdgelessAlignPanel = class extends _classSuper {
        ...
        static {
            ...
            EdgelessAlignPanel = _classThis = _classDescriptor.value;
  ...
  `; }
        #value_accessor_storage = __runInitializers(this, _value_initializers, TextAlign.Left);
    ...
    return EdgelessAlignPanel = _classThis;
})();
