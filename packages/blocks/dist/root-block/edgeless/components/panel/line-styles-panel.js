...
import { BanIcon, DashLineIcon, StraightLineIcon, } from '../../../../_common/icons/edgeless.js';
...
export function LineStylesPanel({ onClick, selectedLineSize, selectedLineStyle, lineStyles = [StrokeStyle.Solid, StrokeStyle.Dash, StrokeStyle.None], } = {}) {
