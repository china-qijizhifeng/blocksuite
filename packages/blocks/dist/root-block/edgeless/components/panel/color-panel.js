...
export const GET_DEFAULT_LINE_COLOR = () => getThemeMode() === 'dark' ? LINE_COLORS[11] : LINE_COLORS[9];
...
let EdgelessColorPanel = (() => {
  ...
  `; }
        ...
        #options_accessor_storage = (__runInitializers(this, _value_extraInitializers), __runInitializers(this, _options_initializers, LINE_COLORS));
        ...
        #hollowCircle_accessor_storage = (__runInitializers(this, _showLetterMark_extraInitializers), __runInitializers(this, _hollowCircle_initializers, false));
        get hollowCircle() { return this.#hollowCircle_accessor_storage; }
        set hollowCircle(value) { this.#hollowCircle_accessor_storage = value; }
        onSelect(value) {
