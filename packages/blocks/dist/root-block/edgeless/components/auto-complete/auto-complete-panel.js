...
import { FrameIcon, SmallNoteIcon, } from '../../../../_common/icons/edgeless.js';
import { FontFamilyIcon } from '../../../../_common/icons/text.js';
import { FontFamily, FontStyle, FontWeight, } from '../../../../surface-block/consts.js';
import { CanvasElementType, TextElementModel, } from '../../../../surface-block/element-model/index.js';
import { Bound, clamp, GroupElementModel, normalizeDegAngle, serializeXYWH, toDegree, Vec, } from '../../../../surface-block/index.js';
...
import { AutoCompleteFrameOverlay, AutoCompleteNoteOverlay, AutoCompleteShapeOverlay, AutoCompleteTextOverlay, capitalizeFirstLetter, createShapeElement, DEFAULT_NOTE_BACKGROUND_COLOR, DEFAULT_NOTE_OVERLAY_HEIGHT, DEFAULT_TEXT_HEIGHT, DEFAULT_TEXT_WIDTH, Direction, isShape, PANEL_HEIGHT, PANEL_WIDTH, } from './utils.js';
let EdgelessAutoCompletePanel = (() => {
  ...
  `; }
        ...
        constructor(position, edgeless, currentSource, connector) {
            ...
            this.#currentSource_accessor_storage = (__runInitializers(this, _position_extraInitializers), __runInitializers(this, _currentSource_initializers, void 0));
            this.#connector_accessor_storage = (__runInitializers(this, _currentSource_extraInitializers), __runInitializers(this, _connector_initializers, void 0));
            __runInitializers(this, _connector_extraInitializers);
        ...
        _showShapeOverlay(targetType) {
            ...
            const { x, y, w, h } = bound;
            const xywh = [x, y, w, h];
            const { shapeStyle, strokeColor, fillColor, strokeWidth, roughness } = isShape(this.currentSource)
                ? this.currentSource
        ...
        _addText() {
            ...
            if (textFlag) {
                const textService = this.edgeless.host.spec.getService('affine:edgeless-text');
