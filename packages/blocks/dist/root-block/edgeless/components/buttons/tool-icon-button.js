...
let EdgelessToolIconButton = (() => {
    let _classDecorators = [customElement('edgeless-tool-icon-button')];
    ...
    var EdgelessToolIconButton = class extends _classSuper {
        ...
        static {
            ...
            EdgelessToolIconButton = _classThis = _classDescriptor.value;
  ...
  `; }
        ...
        #coming_accessor_storage = (__runInitializers(this, _disabled_extraInitializers), __runInitializers(this, _coming_initializers, false));
        get coming() { return this.#coming_accessor_storage; }
        set coming(value) { this.#coming_accessor_storage = value; }
        #showTooltip_accessor_storage = (__runInitializers(this, _coming_extraInitializers), __runInitializers(this, _showTooltip_initializers, true));
        get showTooltip() { return this.#showTooltip_accessor_storage; }
        set showTooltip(value) { this.#showTooltip_accessor_storage = value; }
        #tooltip_accessor_storage = (__runInitializers(this, _showTooltip_extraInitializers), __runInitializers(this, _tooltip_initializers, void 0));
        get tooltip() { return this.#tooltip_accessor_storage; }
        set tooltip(value) { this.#tooltip_accessor_storage = value; }
        #tipPosition_accessor_storage = (__runInitializers(this, _tooltip_extraInitializers), __runInitializers(this, _tipPosition_initializers, 'top'));
        get tipPosition() { return this.#tipPosition_accessor_storage; }
        set tipPosition(value) { this.#tipPosition_accessor_storage = value; }
        #arrow_accessor_storage = (__runInitializers(this, _tipPosition_extraInitializers), __runInitializers(this, _arrow_initializers, true));
        get arrow() { return this.#arrow_accessor_storage; }
        set arrow(value) { this.#arrow_accessor_storage = value; }
        #tooltipOffset_accessor_storage = (__runInitializers(this, _arrow_extraInitializers), __runInitializers(this, _tooltipOffset_initializers, 8));
        ...
        #active_accessor_storage = (__runInitializers(this, _tooltipOffset_extraInitializers), __runInitializers(this, _active_initializers, false));
        ...
        #iconContainerWidth_accessor_storage = (__runInitializers(this, _activeMode_extraInitializers), __runInitializers(this, _iconContainerWidth_initializers, undefined));
        ...
        #iconContainerPadding_accessor_storage = (__runInitializers(this, _iconContainerWidth_extraInitializers), __runInitializers(this, _iconContainerPadding_initializers, 2));
        ...
        #iconSize_accessor_storage = (__runInitializers(this, _iconContainerPadding_extraInitializers), __runInitializers(this, _iconSize_initializers, undefined));
        get iconSize() { return this.#iconSize_accessor_storage; }
        set iconSize(value) { this.#iconSize_accessor_storage = value; }
        #labelHeight_accessor_storage = (__runInitializers(this, _iconSize_extraInitializers), __runInitializers(this, _labelHeight_initializers, undefined));
        get labelHeight() { return this.#labelHeight_accessor_storage; }
        set labelHeight(value) { this.#labelHeight_accessor_storage = value; }
        #withHover_accessor_storage = (__runInitializers(this, _labelHeight_extraInitializers), __runInitializers(this, _withHover_initializers, undefined));
        get withHover() { return this.#withHover_accessor_storage; }
        set withHover(value) { this.#withHover_accessor_storage = value; }
        #justify_accessor_storage = (__runInitializers(this, _withHover_extraInitializers), __runInitializers(this, _justify_initializers, undefined));
        get justify() { return this.#justify_accessor_storage; }
        set justify(value) { this.#justify_accessor_storage = value; }
        #hover_accessor_storage = (__runInitializers(this, _justify_extraInitializers), __runInitializers(this, _hover_initializers, true));
        ...
        constructor() {
            super();
            __runInitializers(this, _hoverState_extraInitializers);
    ...
    return EdgelessToolIconButton = _classThis;
})();
