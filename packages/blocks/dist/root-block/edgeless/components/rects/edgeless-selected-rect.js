...
import { requestThrottledConnectFrame, stopPropagation, } from '../../../../_common/utils/event.js';
...
import { EMBED_HTML_MIN_HEIGHT, EMBED_HTML_MIN_WIDTH, } from '../../../../embed-html-block/styles.js';
import { SYNCED_MIN_HEIGHT, SYNCED_MIN_WIDTH, } from '../../../../embed-synced-doc-block/styles.js';
...
import { CanvasElementType, deserializeXYWH, GroupElementModel, ShapeElementModel, } from '../../../../surface-block/index.js';
import { Bound, ConnectorElementModel, normalizeDegAngle, normalizeShapeBound, } from '../../../../surface-block/index.js';
import { NOTE_MIN_HEIGHT, NOTE_MIN_WIDTH } from '../../utils/consts.js';
import { getElementsWithoutGroup } from '../../utils/group.js';
import { getSelectableBounds, getSelectedRect, isAttachmentBlock, isBookmarkBlock, isCanvasElement, isEdgelessTextBlock, isEmbeddedBlock, isEmbedFigmaBlock, isEmbedGithubBlock, isEmbedHtmlBlock, isEmbedLinkedDocBlock, isEmbedLoomBlock, isEmbedSyncedDocBlock, isEmbedYoutubeBlock, isFrameBlock, isImageBlock, isNoteBlock, } from '../../utils/query.js';
...
let EdgelessSelectedRect = (() => {
    let _classDecorators = [customElement('edgeless-selected-rect')];
    ...
    var EdgelessSelectedRect = class extends _classSuper {
        ...
        static {
            ...
            _autoCompleteOff_decorators = [property({ attribute: false })];
            ...
            EdgelessSelectedRect = _classThis = _classDescriptor.value;
  ...
  `; }
        ...
        constructor() {
            ...
            this.#_isResizing_accessor_storage = (__runInitializers(this, __selectedRect_extraInitializers), __runInitializers(this, __isResizing_initializers, false));
            this.#_mode_accessor_storage = (__runInitializers(this, __isResizing_extraInitializers), __runInitializers(this, __mode_initializers, 'resize'));
            this.#_scalePercent_accessor_storage = (__runInitializers(this, __mode_extraInitializers), __runInitializers(this, __scalePercent_initializers, undefined));
            this.#_scaleDirection_accessor_storage = (__runInitializers(this, __scalePercent_extraInitializers), __runInitializers(this, __scaleDirection_initializers, undefined));
            this.#_isWidthLimit_accessor_storage = (__runInitializers(this, __scaleDirection_extraInitializers), __runInitializers(this, __isWidthLimit_initializers, false));
            this.#_isHeightLimit_accessor_storage = (__runInitializers(this, __isWidthLimit_extraInitializers), __runInitializers(this, __isHeightLimit_initializers, false));
            this.#_shiftKey_accessor_storage = (__runInitializers(this, __isHeightLimit_extraInitializers), __runInitializers(this, __shiftKey_initializers, false));
            this._resizeManager = __runInitializers(this, __shiftKey_extraInitializers);
            this._cursorRotate = 0;
            this._propDisposables = [];
            this._dragEndCallback = [];
            this._updateSelectedRect = requestThrottledConnectFrame(() => {
            ...
            this.#autoCompleteOff_accessor_storage = (__runInitializers(this, _edgeless_extraInitializers), __runInitializers(this, _autoCompleteOff_initializers, false));
            this.slots = (__runInitializers(this, _autoCompleteOff_extraInitializers), {
                dragStart: new Slot(),
                dragMove: new Slot(),
                dragRotate: new Slot(),
                dragEnd: new Slot(),
        ...
        #adjustEdgelessText(element, bound, direction) {
            ...
            if (direction === HandleDirection.TopLeft ||
                ...
                const textPortal = this.edgeless.rootElementContainer.getPortalElement(element.id);
                if (!textPortal)
                    return;
        ...
        render() {
            ...
            if (!inoperable) {
                const resizeHandles = hasResizeHandles
                    ...
                    : nothing;
                const connectorHandle = elements.length === 1 && elements[0] instanceof ConnectorElementModel
                    ? html `
            ...
            const isSingleGroup = elements.length === 1 && elements[0] instanceof GroupElementModel;
    ...
    return EdgelessSelectedRect = _classThis;
})();
