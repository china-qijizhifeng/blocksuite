...
export class EdgelessSelectionManager {
    ...
    set(selection) {
        if (Array.isArray(selection)) {
            this.stdSelectionManager.setGroup('edgeless', this.cursorSelection ? [...selection, this.cursorSelection] : selection);
            return;
        }
        ...
        this.stdSelectionManager.setGroup('edgeless', this.cursorSelection
