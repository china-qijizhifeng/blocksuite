...
declare global {
    namespace BlockSuite {
        ...
        type EdgelessBlockModelType = EdgelessBlockModelMap[EdgelessBlockModelKeyType] | EdgelessBlockModel;
        ...
        type EdgelessToolControllerType = EdgelessToolMap[EdgelessToolControllerKeyType];
