...
export class PageKeyboardManager {
    ...
    _createEmbedBlock() {
        ...
        void promptDocTitle(rootElement.host, autofill).then(title => {
            if (title === null)
                return;
            const linkedDoc = convertSelectedBlocksToLinkedDoc(doc, selectedModels, title);
            const linkedDocService = rootElement.host.spec.getService('affine:embed-linked-doc');
