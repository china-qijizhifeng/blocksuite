...
import { AIStarIconWithAnimation, AIStopIcon, } from '../../../../../_common/icons/ai.js';
let AIPanelGenerating = (() => {
  ...
  `; }
        ...
        #withAnswer_accessor_storage = (__runInitializers(this, _loadingProgress_extraInitializers), __runInitializers(this, _withAnswer_initializers, void 0));
        get withAnswer() { return this.#withAnswer_accessor_storage; }
        set withAnswer(value) { this.#withAnswer_accessor_storage = value; }
        #stopGenerating_accessor_storage = (__runInitializers(this, _withAnswer_extraInitializers), __runInitializers(this, _stopGenerating_initializers, void 0));
