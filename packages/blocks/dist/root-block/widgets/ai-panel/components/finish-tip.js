...
let AIFinishTip = (() => {
  ...
  `; }
        #copy_accessor_storage = __runInitializers(this, _copy_initializers, undefined);
        get copy() { return this.#copy_accessor_storage; }
        set copy(value) { this.#copy_accessor_storage = value; }
        #copied_accessor_storage = (__runInitializers(this, _copy_extraInitializers), __runInitializers(this, _copied_initializers, false));
