...
let GeneratingPlaceholder = (() => {
  ...
  `; }
        ...
        #stages_accessor_storage = (__runInitializers(this, _loadingProgress_extraInitializers), __runInitializers(this, _stages_initializers, void 0));
        get stages() { return this.#stages_accessor_storage; }
        set stages(value) { this.#stages_accessor_storage = value; }
        #showHeader_accessor_storage = (__runInitializers(this, _stages_extraInitializers), __runInitializers(this, _showHeader_initializers, void 0));
      ...
      <div class="generating-body">
        ...
        constructor() {
            super(...arguments);
            __runInitializers(this, _showHeader_extraInitializers);
        }
        static {
