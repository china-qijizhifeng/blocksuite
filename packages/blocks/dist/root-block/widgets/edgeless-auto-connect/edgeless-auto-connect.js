...
import { AutoConnectLeftIcon, AutoConnectRightIcon, HiddenIcon, } from '../../../_common/icons/edgeless.js';
...
let EdgelessAutoConnectWidget = (() => {
  ...
  `; }
        #_show_accessor_storage = __runInitializers(this, __show_initializers, false);
        get _show() { return this.#_show_accessor_storage; }
        set _show(value) { this.#_show_accessor_storage = value; }
        #_pageVisibleElementsMap_accessor_storage = (__runInitializers(this, __show_extraInitializers), __runInitializers(this, __pageVisibleElementsMap_initializers, new Map()));
        ...
        #_edgelessOnlyNotesSet_accessor_storage = (__runInitializers(this, __pageVisibleElementsMap_extraInitializers), __runInitializers(this, __edgelessOnlyNotesSet_initializers, new Set()));
        ...
        #_index_accessor_storage = (__runInitializers(this, __edgelessOnlyNotesSet_extraInitializers), __runInitializers(this, __index_initializers, -1));
    ...
    ${this._index >= 0 && this._index < elements.length
        ...
        constructor() {
            super(...arguments);
            __runInitializers(this, __index_extraInitializers);
        }
        static {
