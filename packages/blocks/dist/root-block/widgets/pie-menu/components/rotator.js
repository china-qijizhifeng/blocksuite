...
let PieCenterRotator = (() => {
    ...
    var PieCenterRotator = class extends _classSuper {
        ...
        #angle_accessor_storage = (__runInitializers(this, _isActive_extraInitializers), __runInitializers(this, _angle_initializers, null));
        ...
        constructor() {
            super(...arguments);
            __runInitializers(this, _angle_extraInitializers);
        }
        static {
