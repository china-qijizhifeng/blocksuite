...
let PieNodeContent = (() => {
    ...
    var PieNodeContent = class extends _classSuper {
        ...
        #node_accessor_storage = (__runInitializers(this, __nodeContentElement_extraInitializers), __runInitializers(this, _node_initializers, void 0));
        get node() { return this.#node_accessor_storage; }
        set node(value) { this.#node_accessor_storage = value; }
        #isActive_accessor_storage = (__runInitializers(this, _node_extraInitializers), __runInitializers(this, _isActive_initializers, void 0));
        get isActive() { return this.#isActive_accessor_storage; }
        set isActive(value) { this.#isActive_accessor_storage = value; }
        #hoveredNode_accessor_storage = (__runInitializers(this, _isActive_extraInitializers), __runInitializers(this, _hoveredNode_initializers, void 0));
    ...
    `;
        ...
        constructor() {
            super(...arguments);
            __runInitializers(this, _hoveredNode_extraInitializers);
        }
        static {
