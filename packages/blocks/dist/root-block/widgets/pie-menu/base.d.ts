...
export type IPieNodeWithAction = PieCommandNodeModel | (PieSubmenuNodeModel & {
    role: 'command';
    action: ActionFunction;
});
export type PieNonRootNode = PieCommandNodeModel | PieColorNodeModel | PieSubmenuNodeModel;
