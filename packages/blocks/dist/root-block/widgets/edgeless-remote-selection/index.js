...
let EdgelessRemoteSelectionWidget = (() => {
    ...
    var EdgelessRemoteSelectionWidget = class extends _classSuper {
        ...
        constructor() {
            super(...arguments);
            this.#_remoteRects_accessor_storage = __runInitializers(this, __remoteRects_initializers, new Map());
            this.#_remoteCursors_accessor_storage = (__runInitializers(this, __remoteRects_extraInitializers), __runInitializers(this, __remoteCursors_initializers, new Map()));
            this._remoteColorManager = (__runInitializers(this, __remoteCursors_extraInitializers), null);
            this._updateTransform = requestThrottledConnectFrame(() => {
