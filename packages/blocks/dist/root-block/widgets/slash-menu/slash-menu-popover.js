...
import { getInlineEditorByModel, isControlledKeyboardEvent, } from '../../../_common/utils/index.js';
...
let SlashMenu = (() => {
    ...
    var SlashMenu = class extends _classSuper {
        ...
        constructor() {
            ...
            this._innerSlashMenuContext = __runInitializers(this, __position_extraInitializers);
            ...
            this.#config_accessor_storage = (__runInitializers(this, _context_extraInitializers), __runInitializers(this, _config_initializers, void 0));
            this.#triggerKey_accessor_storage = (__runInitializers(this, _config_extraInitializers), __runInitializers(this, _triggerKey_initializers, void 0));
            this.#slashMenuElement_accessor_storage = (__runInitializers(this, _triggerKey_extraInitializers), __runInitializers(this, _slashMenuElement_initializers, void 0));
            this.abortController = (__runInitializers(this, _slashMenuElement_extraInitializers), new AbortController());
            ...
            this._updateFilteredItems = (query) => {
                ...
                this._filteredItems = this._filteredItems.sort((a, b) => {
                    if (a.name.toLowerCase() === searchStr)
                        return -1;
                    if (b.name.toLowerCase() === searchStr)
                        return 1;
...
let InnerSlashMenu = (() => {
    ...
    var InnerSlashMenu = class extends _classSuper {
        ...
        constructor() {
            ...
            this._currentSubMenu = (__runInitializers(this, __activeItem_extraInitializers), null);
            this._subMenuAbortController = null;
            this.#context_accessor_storage = __runInitializers(this, _context_initializers, void 0);
            this.#menu_accessor_storage = (__runInitializers(this, _context_extraInitializers), __runInitializers(this, _menu_initializers, void 0));
            this.#depth_accessor_storage = (__runInitializers(this, _menu_extraInitializers), __runInitializers(this, _depth_initializers, 0));
            this.#abortController_accessor_storage = (__runInitializers(this, _depth_extraInitializers), __runInitializers(this, _abortController_initializers, void 0));
            this.#mainMenuStyle_accessor_storage = (__runInitializers(this, _abortController_extraInitializers), __runInitializers(this, _mainMenuStyle_initializers, null));
            this._openSubMenu = (__runInitializers(this, _mainMenuStyle_extraInitializers), (item) => {
    ...
    >
      ...
      <div slot="suffix" style="transform: rotate(-90deg);">
        ...
        connectedCallback() {
            ...
            const inlineEditor = getInlineEditorByModel(this.context.rootElement.host, this.context.model);
            assertExists(inlineEditor, 'RichText InlineEditor not found');
