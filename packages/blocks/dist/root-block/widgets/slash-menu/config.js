...
import { ArrowDownBigIcon, ArrowUpBigIcon, CopyIcon, DeleteIcon, HeadingIcon, NowIcon, PasteIcon, TodayIcon, TomorrowIcon, YesterdayIcon, } from '../../../_common/icons/index.js';
...
import { createConversionItem, formatDate, formatTime, insertContent, insideDatabase, insideEdgelessText, } from './utils.js';
    ...
    items: [
        ...
        ...textFormatConfigs
            ...
            action: ({ rootElement, model }) => {
                ...
                if (!len) {
                    const inlineEditor = getInlineEditorByModel(rootElement.host, model);
                    assertExists(inlineEditor, "Can't set style mark! Inline editor not found");
        ...
        },
        {
            ...
            action: ({ rootElement, model }) => {
                ...
                rootElement.doc.addBlock(model.flavour, {
                    type: model.type,
                    text: rootElement.doc.Text.fromDelta(model.text.toDelta()),
                    // @ts-expect-error
                    checked: model.checked,
                }, rootElement.doc.getParent(model), index);
            },
        },
        {
            name: 'Delete',
