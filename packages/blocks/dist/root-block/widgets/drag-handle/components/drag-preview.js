...
let DragPreview = (() => {
    ...
    var DragPreview = class extends _classSuper {
        ...
        #template_accessor_storage = __runInitializers(this, _template_initializers, null);
        get template() { return this.#template_accessor_storage; }
        set template(value) { this.#template_accessor_storage = value; }
        #onRemove_accessor_storage = (__runInitializers(this, _template_extraInitializers), __runInitializers(this, _onRemove_initializers, null));
