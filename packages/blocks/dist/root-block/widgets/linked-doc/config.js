...
import { DocIcon, ImportIcon, NewDocIcon, } from '../../../_common/icons/index.js';
...
export const getMenus = ({ editorHost, query, inlineEditor, docMetas }) => {
            ...
            items: [
                {
                    ...
                    action: () => {
                        ...
                        const telemetryService = editorHost.spec.getService('affine:page').telemetryService;
                        telemetryService?.track('LinkedDocCreated', {
                            control: 'new doc',
                            module: 'inline @',
                            type: 'doc',
