...
export type DefaultItemConfig = {
    ...
    action: (blockElement: ImageBlockComponent, abortController: AbortController, onClick?: () => void) => void;
};
...
export type CustomItem = {
    showWhen: (blockElement: ImageBlockComponent) => boolean;
    render: (blockElement: ImageBlockComponent, onClick?: () => void) => TemplateResult | null;
    type: 'custom';
};
