...
import type { BrushElementModel, GroupElementModel } from '../surface-block/index.js';
...
export type Connectable = Exclude<BlockSuite.EdgelessModelType, ConnectorElementModel | BrushElementModel | GroupElementModel>;
...
export type EmbedCardStyle = 'horizontal' | 'horizontalThin' | 'list' | 'vertical' | 'cube' | 'cubeThick' | 'video' | 'figma' | 'html' | 'syncedDoc';
export {};
