...
let DragIndicator = (() => {
    let _classDecorators = [customElement('affine-drag-indicator')];
    ...
    var DragIndicator = class extends _classSuper {
        ...
        static {
            ...
            DragIndicator = _classThis = _classDescriptor.value;
  ...
  `; }
    ...
    return DragIndicator = _classThis;
})();
