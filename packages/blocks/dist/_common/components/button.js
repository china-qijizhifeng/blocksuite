...
let IconButton = (() => {
    ...
    var IconButton = class extends _classSuper {
        ...
        static {
            ...
            _hover_decorators = [property({ attribute: true, type: Boolean })];
  ...
  `; }
        #size_accessor_storage = __runInitializers(this, _size_initializers, null);
        get size() { return this.#size_accessor_storage; }
        set size(value) { this.#size_accessor_storage = value; }
        #width_accessor_storage = (__runInitializers(this, _size_extraInitializers), __runInitializers(this, _width_initializers, null));
        get width() { return this.#width_accessor_storage; }
        set width(value) { this.#width_accessor_storage = value; }
        #height_accessor_storage = (__runInitializers(this, _width_extraInitializers), __runInitializers(this, _height_initializers, null));
        get height() { return this.#height_accessor_storage; }
        set height(value) { this.#height_accessor_storage = value; }
        #text_accessor_storage = (__runInitializers(this, _height_extraInitializers), __runInitializers(this, _text_initializers, null));
        get text() { return this.#text_accessor_storage; }
        set text(value) { this.#text_accessor_storage = value; }
        #subText_accessor_storage = (__runInitializers(this, _text_extraInitializers), __runInitializers(this, _subText_initializers, null));
        get subText() { return this.#subText_accessor_storage; }
        set subText(value) { this.#subText_accessor_storage = value; }
        #active_accessor_storage = (__runInitializers(this, _subText_extraInitializers), __runInitializers(this, _active_initializers, false));
        get active() { return this.#active_accessor_storage; }
        set active(value) { this.#active_accessor_storage = value; }
        #hover_accessor_storage = (__runInitializers(this, _active_extraInitializers), __runInitializers(this, _hover_initializers, undefined));
        get hover() { return this.#hover_accessor_storage; }
        set hover(value) { this.#hover_accessor_storage = value; }
        #disabled_accessor_storage = (__runInitializers(this, _hover_extraInitializers), __runInitializers(this, _disabled_initializers, undefined));
