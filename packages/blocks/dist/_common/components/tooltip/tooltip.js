...
let Tooltip = (() => {
    ...
    var Tooltip = class extends _classSuper {
        ...
        constructor() {
            super(...arguments);
            this.#placement_accessor_storage = __runInitializers(this, _placement_initializers, 'top');
            this.#zIndex_accessor_storage = (__runInitializers(this, _placement_extraInitializers), __runInitializers(this, _zIndex_initializers, 'var(--affine-z-index-popover)'));
            this.#tooltipStyle_accessor_storage = (__runInitializers(this, _zIndex_extraInitializers), __runInitializers(this, _tooltipStyle_initializers, css ``));
            this.#autoFlip_accessor_storage = (__runInitializers(this, _tooltipStyle_extraInitializers), __runInitializers(this, _autoFlip_initializers, true));
            this.#arrow_accessor_storage = (__runInitializers(this, _autoFlip_extraInitializers), __runInitializers(this, _arrow_initializers, true));
            this.#offset_accessor_storage = (__runInitializers(this, _arrow_extraInitializers), __runInitializers(this, _offset_initializers, 4));
            this.#allowInteractive_accessor_storage = (__runInitializers(this, _offset_extraInitializers), __runInitializers(this, _allowInteractive_initializers, false));
            this.#hoverOptions_accessor_storage = (__runInitializers(this, _allowInteractive_extraInitializers), __runInitializers(this, _hoverOptions_initializers, {}));
            this._setUpHoverController = (__runInitializers(this, _hoverOptions_extraInitializers), () => {
