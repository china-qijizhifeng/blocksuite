import { asyncFocusRichText, getInlineEditorByModel, matchFlavours, } from '../../../../_common/utils/index.js';
function addSpace(element, index) {
...
export function convertToList(element, listType, prefix, otherProperties) {
...
export function convertToParagraph(element, type, prefix) {
    const { doc, model } = element;
...
export function convertToDivider(element, prefix) {
    const { doc, model } = element;
