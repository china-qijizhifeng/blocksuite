...
let RichText = (() => {
  ...
  `; }
        ...
        _init() {
            ...
            // init auto scroll
            inlineEditor.disposables.add(inlineEditor.slots.inlineRangeUpdate.on(([inlineRange, sync]) => {
                if (!inlineRange || !sync)
                    return;
                // lazy
                ...
                inlineEditor
                    ...
                    if (this.enableAutoScrollHorizontally) {
                        const containerRect = this.inlineEditorContainer.getBoundingClientRect();
                        const rangeRect = range.getBoundingClientRect();
    ...
    ></div>`;
        ...
        constructor() {
            ...
            this._inlineEditor = (__runInitializers(this, __inlineEditorContainer_extraInitializers), null);
            this.#yText_accessor_storage = __runInitializers(this, _yText_initializers, void 0);
            this.#attributesSchema_accessor_storage = (__runInitializers(this, _yText_extraInitializers), __runInitializers(this, _attributesSchema_initializers, undefined));
            this.#attributeRenderer_accessor_storage = (__runInitializers(this, _attributesSchema_extraInitializers), __runInitializers(this, _attributeRenderer_initializers, undefined));
            this.#inlineEventSource_accessor_storage = (__runInitializers(this, _attributeRenderer_extraInitializers), __runInitializers(this, _inlineEventSource_initializers, undefined));
            this.#markdownShortcutHandler_accessor_storage = (__runInitializers(this, _inlineEventSource_extraInitializers), __runInitializers(this, _markdownShortcutHandler_initializers, undefined));
            ...
            this.#inlineRangeProvider_accessor_storage = (__runInitializers(this, _readonly_extraInitializers), __runInitializers(this, _inlineRangeProvider_initializers, undefined));
            this.#undoManager_accessor_storage = (__runInitializers(this, _inlineRangeProvider_extraInitializers), __runInitializers(this, _undoManager_initializers, void 0));
            this.#enableClipboard_accessor_storage = (__runInitializers(this, _undoManager_extraInitializers), __runInitializers(this, _enableClipboard_initializers, true));
            this.#enableUndoRedo_accessor_storage = (__runInitializers(this, _enableClipboard_extraInitializers), __runInitializers(this, _enableUndoRedo_initializers, true));
            this.#enableAutoScrollHorizontally_accessor_storage = (__runInitializers(this, _enableUndoRedo_extraInitializers), __runInitializers(this, _enableAutoScrollHorizontally_initializers, true));
            this.#wrapText_accessor_storage = (__runInitializers(this, _enableAutoScrollHorizontally_extraInitializers), __runInitializers(this, _wrapText_initializers, true));
            this.#enableFormat_accessor_storage = (__runInitializers(this, _wrapText_extraInitializers), __runInitializers(this, _enableFormat_initializers, true));
            this.#verticalScrollContainerGetter_accessor_storage = (__runInitializers(this, _enableFormat_extraInitializers), __runInitializers(this, _verticalScrollContainerGetter_initializers, undefined));
            this.#verticalScrollContainer = (__runInitializers(this, _verticalScrollContainerGetter_extraInitializers), null);
            ...
            this.#embedChecker_accessor_storage = __runInitializers(this, _embedChecker_initializers, () => false);
            __runInitializers(this, _embedChecker_extraInitializers);
        }
        static {
