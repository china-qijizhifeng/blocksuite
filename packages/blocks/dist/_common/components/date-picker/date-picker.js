    ...
    >
      ...
      <div class=${classes} style=${styleMap(this._cardStyle)}>
        ...
        constructor() {
            ...
            this.#_monthCursor_accessor_storage = __runInitializers(this, __monthCursor_initializers, 0);
            this.#_yearCursor_accessor_storage = (__runInitializers(this, __monthCursor_extraInitializers), __runInitializers(this, __yearCursor_initializers, 0));
            this.#_monthPickYearCursor_accessor_storage = (__runInitializers(this, __yearCursor_extraInitializers), __runInitializers(this, __monthPickYearCursor_initializers, 0));
            this.#_matrix_accessor_storage = (__runInitializers(this, __monthPickYearCursor_extraInitializers), __runInitializers(this, __matrix_initializers, []));
            this.#_yearMatrix_accessor_storage = (__runInitializers(this, __matrix_extraInitializers), __runInitializers(this, __yearMatrix_initializers, []));
            this.#_mode_accessor_storage = (__runInitializers(this, __yearMatrix_extraInitializers), __runInitializers(this, __mode_initializers, 'date'));
            this._maxYear = (__runInitializers(this, __mode_extraInitializers), 2099);
            this._minYear = 1970;
            this.#value_accessor_storage = __runInitializers(this, _value_initializers, undefined);
            this.#onChange_accessor_storage = (__runInitializers(this, _value_extraInitializers), __runInitializers(this, _onChange_initializers, undefined));
            this.#padding_accessor_storage = (__runInitializers(this, _onChange_extraInitializers), __runInitializers(this, _padding_initializers, 20));
            ...
            this.#gapH_accessor_storage = (__runInitializers(this, _size_extraInitializers), __runInitializers(this, _gapH_initializers, 10));
            this.#gapV_accessor_storage = (__runInitializers(this, _gapH_extraInitializers), __runInitializers(this, _gapV_initializers, 8));
            __runInitializers(this, _gapV_extraInitializers);
        }
        static {
