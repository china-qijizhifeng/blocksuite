...
let AISubItemList = (() => {
    let _classDecorators = [customElement('ai-sub-item-list')];
    ...
    var AISubItemList = class extends _classSuper {
        ...
        constructor() {
            ...
            this.#abortController_accessor_storage = (__runInitializers(this, _item_extraInitializers), __runInitializers(this, _abortController_initializers, void 0));
            this.#onClick_accessor_storage = (__runInitializers(this, _abortController_extraInitializers), __runInitializers(this, _onClick_initializers, void 0));
            this._handleClick = (__runInitializers(this, _onClick_extraInitializers), (subItem) => {
                if (subItem.handler) {
