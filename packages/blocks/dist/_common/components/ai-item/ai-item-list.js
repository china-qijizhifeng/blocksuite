...
let AIItemList = (() => {
    let _classDecorators = [customElement('ai-item-list')];
    ...
    var AIItemList = class extends _classSuper {
        ...
        constructor() {
            ...
            this.#groups_accessor_storage = (__runInitializers(this, _host_extraInitializers), __runInitializers(this, _groups_initializers, void 0));
            this.#onClick_accessor_storage = (__runInitializers(this, _groups_extraInitializers), __runInitializers(this, _onClick_initializers, undefined));
            this._itemClassName = (__runInitializers(this, _onClick_extraInitializers), (item) => {
