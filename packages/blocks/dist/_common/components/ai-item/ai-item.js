...
let AIItem = (() => {
    let _classDecorators = [customElement('ai-item')];
  ...
  `; }
        ...
        #onClick_accessor_storage = (__runInitializers(this, _host_extraInitializers), __runInitializers(this, _onClick_initializers, void 0));
        get onClick() { return this.#onClick_accessor_storage; }
        set onClick(value) { this.#onClick_accessor_storage = value; }
        #menuItem_accessor_storage = (__runInitializers(this, _onClick_extraInitializers), __runInitializers(this, _menuItem_initializers, void 0));
