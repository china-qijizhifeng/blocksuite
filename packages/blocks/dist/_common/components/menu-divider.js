...
let MenuDivider = (() => {
  ...
  `; }
        #vertical_accessor_storage = __runInitializers(this, _vertical_initializers, false);
        get vertical() { return this.#vertical_accessor_storage; }
        set vertical(value) { this.#vertical_accessor_storage = value; }
        #dividerMargin_accessor_storage = (__runInitializers(this, _vertical_extraInitializers), __runInitializers(this, _dividerMargin_initializers, 7));
    ...
    ></div>`;
        ...
        constructor() {
            super(...arguments);
            __runInitializers(this, _dividerMargin_extraInitializers);
        }
        static {
