...
import { EmbedLinkedDocBlockComponent, type EmbedLinkedDocModel } from '../../../embed-linked-doc-block/index.js';
...
export type EmbedToolbarBlockElement = BookmarkBlockComponent | EmbedGithubBlockComponent | EmbedYoutubeBlockComponent | EmbedFigmaBlockComponent | EmbedLinkedDocBlockComponent | EmbedSyncedDocBlockComponent | EmbedLoomBlockComponent;
export type EmbedToolbarModel = BookmarkBlockModel | EmbedGithubModel | EmbedYoutubeModel | EmbedFigmaModel | EmbedLinkedDocModel | EmbedSyncedDocModel | EmbedLoomModel;
export declare function isEmbedCardBlockElement(block: BlockElement): block is EmbedToolbarBlockElement;
