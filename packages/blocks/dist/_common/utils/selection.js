...
import { asyncGetRichTextByModel, buildPath, getDocTitleInlineEditor, getPageRootByElement, } from './query.js';
...
export function asyncFocusRichText(editorHost, id, inlineRange = { index: 0, length: 0 }) {
