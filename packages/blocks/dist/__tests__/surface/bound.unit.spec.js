...
import { Bound, getCommonBound, inflateBound, transformPointsToNewBound, } from '../../surface-block/utils/bound.js';
describe('bound utils', () => {
    ...
    it('inflateBound', () => {
        ...
        expect(() => inflateBound(a, -12)).toThrowError('Invalid delta range or bound size.');
    });
    it('transformPointsToNewBound basic', () => {
        ...
        const transformed = transformPointsToNewBound(points, a, marginA, b, marginB);
...
//# sourceMappingURL=bound.unit.spec.js.map