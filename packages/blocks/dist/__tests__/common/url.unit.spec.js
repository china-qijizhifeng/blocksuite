...
describe('isValidUrl: determining whether a URL is valid is very complicated', () => {
    test('basic case', () => {
        ...
        expect(isValidUrl('http://www.github.com/toeverything/blocksuite')).toEqual(true);
    });
    ...
    test('email link is a valid URL', () => {
        ...
        expect(isValidUrl('mailto:name@rapidtables.com?subject=The%20subject%20of%20the%20mail')).toEqual(true);
        expect(isValidUrl('mailto:name1@rapidtables.com?cc=name2@rapidtables.com&bcc=name3@rapidtables.com&subject=The%20subject%20of%20the%20email&body=The%20body%20of%20the%20email')).toEqual(true);
    ...
    test('misc case', () => {
        ...
        expect(isValidUrl('https://username:password@www.example.com:80/?q_a=1234567')).toEqual(true);
...
//# sourceMappingURL=url.unit.spec.js.map