...
import { atLeastNMatches, countBy, groupBy, maxBy, } from '../../_common/utils/iterable.js';
describe('countBy', () => {
    it('basic', () => {
        const items = [
            { name: 'a', classroom: 'c1' },
...
describe('atLeastNMatches', () => {
    it('basic', () => {
        ...
        const longerThan5 = (str) => str.length > 5;
...
//# sourceMappingURL=iterable.unit.spec.js.map