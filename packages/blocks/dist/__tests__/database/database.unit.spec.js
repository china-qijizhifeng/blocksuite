...
import { columnPresets, richTextColumnConfig, } from '../../database-block/index.js';
...
describe('DatabaseManager', () => {
    ...
    beforeEach(() => {
        ...
        db = databaseModel;
        col1 = db.addColumn('end', columnPresets.numberColumnConfig.model.create('Number'));
        col2 = db.addColumn('end', selectColumnModelConfig.create('Single Select', { options: selection }));
    ...
    test('copyCellsByColumn', () => {
        const newColId = db.addColumn('end', selectColumnModelConfig.create('Copied Select', { options: selection }));
