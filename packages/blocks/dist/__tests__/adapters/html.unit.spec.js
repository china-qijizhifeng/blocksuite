...
describe('snapshot to html', () => {
    test('code', async () => {
        ...
        const html = template(`<pre><code class="code-python"><span style="word-wrap: break-word; color: #AF00DB;">import</span><span style="word-wrap: break-word; color: #000000;"> this</span></code></pre>`);
    ...
    test('code inline', async () => {
        ...
        const html = template(`<div class="affine-paragraph-block-container"><p>aaa <code>bbb</code> ccc</p><div class="affine-block-children-container" style="padding-left: 26px;"></div></div>`);
        const htmlAdapter = new HtmlAdapter(createJob());
        const target = await htmlAdapter.fromBlockSnapshot({
            snapshot: blockSnapshot,
        });
    ...
    test('link', async () => {
        ...
        const html = template(`<div class="affine-paragraph-block-container"><p>aaa <a href="https://affine.pro/">bbb</a> ccc</p><div class="affine-block-children-container" style="padding-left: 26px;"></div></div>`);
        const htmlAdapter = new HtmlAdapter(createJob());
        const target = await htmlAdapter.fromBlockSnapshot({
            snapshot: blockSnapshot,
        });
    ...
    test('bold', async () => {
        ...
        const html = template(`<div class="affine-paragraph-block-container"><p>aaa<strong>bbb</strong>ccc</p><div class="affine-block-children-container" style="padding-left: 26px;"></div></div>`);
        const htmlAdapter = new HtmlAdapter(createJob());
        const target = await htmlAdapter.fromBlockSnapshot({
            snapshot: blockSnapshot,
        });
    ...
    test('italic', async () => {
        ...
        const html = template(`<div class="affine-paragraph-block-container"><p>aaa<em>bbb</em>ccc</p><div class="affine-block-children-container" style="padding-left: 26px;"></div></div>`);
        const htmlAdapter = new HtmlAdapter(createJob());
        const target = await htmlAdapter.fromBlockSnapshot({
            snapshot: blockSnapshot,
        });
    ...
    test('image', async () => {
        ...
        const html = template(`<figure class="affine-image-block-container"><img src="assets/YXXTjRmLlNyiOUnHb8nAIvUP6V7PAXhwW9F5_tc2LGs=.blob" alt="YXXTjRmLlNyiOUnHb8nAIvUP6V7PAXhwW9F5_tc2LGs=.blob" title="aaa"></figure><div class="affine-paragraph-block-container"><p></p><div class="affine-block-children-container" style="padding-left: 26px;"></div></div>`);
        const htmlAdapter = new HtmlAdapter(createJob());
...
describe('html to snapshot', () => {
    test('code', async () => {
        const html = template(`<pre><code class="code-python"><span style="word-wrap: break-word; color: #81A1C1;">import</span><span style="word-wrap: break-word; color: #D8DEE9FF;"> this</span></code></pre>`);
        const blockSnapshot = {
            type: 'block',
    ...
    test('iframe', async () => {
        const html = template(`<iframe width="560" height="315" src="https://www.youtube.com/embed/QDsd0nyzwz0?start=&amp;end=" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`);
        const blockSnapshot = {
            type: 'block',
            id: 'matchesReplaceMap[0]',
            flavour: 'affine:note',
...
//# sourceMappingURL=html.unit.spec.js.map