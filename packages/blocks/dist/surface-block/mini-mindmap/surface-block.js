...
let MindmapSurfaceBlock = (() => {
    ...
    var MindmapSurfaceBlock = class extends _classSuper {
        ...
        #editorContainer_accessor_storage;
        ...
        connectedCallback() {
            ...
            this._renderer = new Renderer({
                ...
                provider: {
                    selectedElements: () => [],
                    getVariableColor: (val) => this._theme.getVariableValue(val),
                },
            });
    ...
    `;
        ...
        constructor() {
            super(...arguments);
            this._theme = new ThemeObserver();
            this.#editorContainer_accessor_storage = __runInitializers(this, _editorContainer_initializers, void 0);
