...
export declare function pointOnPolygonStoke(p: number[], points: IVec[], threshold: number): boolean;
...
export declare function polygonGetPointTangent(points: IVec[], point: IVec): number[];
...
export declare function getPointsFromBoundsWithRotation(bounds: IBound, getPoints?: (bounds: IBound) => IVec[]): IVec[];
