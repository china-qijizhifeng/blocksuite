...
let GroupElementModel = (() => {
    let _classSuper = SurfaceGroupLikeModel;
    ...
    return class GroupElementModel extends _classSuper {
        ...
        #title_accessor_storage = (__runInitializers(this, _children_extraInitializers), __runInitializers(this, _title_initializers, new DocCollection.Y.Text()));
        get title() { return this.#title_accessor_storage; }
        set title(value) { this.#title_accessor_storage = value; }
        #showTitle_accessor_storage = (__runInitializers(this, _title_extraInitializers), __runInitializers(this, _showTitle_initializers, true));
        ...
        constructor() {
            super(...arguments);
            __runInitializers(this, _showTitle_extraInitializers);
        }
    };
})();
