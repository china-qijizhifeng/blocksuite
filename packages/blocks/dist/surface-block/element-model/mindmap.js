...
import { applyNodeStyle, MindmapStyle, mindmapStyleGetters, } from './utils/mindmap/style.js';
    ...
    return class MindmapElementModel extends _classSuper {
        constructor() {
            ...
            this.pathGenerator = new ConnectorPathGenerator({
                getElementById: (id) => this.surface.getElementById(id) ??
                    this.surface.doc.getBlockById(id),
            });
            ...
            this.connectors = (__runInitializers(this, _style_extraInitializers), new Map());
