...
import { DEFAULT_ROUGHNESS, FontFamily, FontStyle, FontWeight, StrokeStyle, TextAlign, TextResizing, TextVerticalAlign, } from '../consts.js';
...
let ShapeElementModel = (() => {
    ...
    return class ShapeElementModel extends _classSuper {
        constructor() {
            super(...arguments);
            this.#textDisplay_accessor_storage = __runInitializers(this, _textDisplay_initializers, true);
            this.#xywh_accessor_storage = (__runInitializers(this, _textDisplay_extraInitializers), __runInitializers(this, _xywh_initializers, '[0,0,100,100]'));
            this.#rotate_accessor_storage = (__runInitializers(this, _xywh_extraInitializers), __runInitializers(this, _rotate_initializers, 0));
            this.#shapeType_accessor_storage = (__runInitializers(this, _rotate_extraInitializers), __runInitializers(this, _shapeType_initializers, 'rect'));
            this.#radius_accessor_storage = (__runInitializers(this, _shapeType_extraInitializers), __runInitializers(this, _radius_initializers, 0));
            this.#filled_accessor_storage = (__runInitializers(this, _radius_extraInitializers), __runInitializers(this, _filled_initializers, false));
            this.#fillColor_accessor_storage = (__runInitializers(this, _filled_extraInitializers), __runInitializers(this, _fillColor_initializers, '--affine-palette-shape-yellow'));
            this.#strokeWidth_accessor_storage = (__runInitializers(this, _fillColor_extraInitializers), __runInitializers(this, _strokeWidth_initializers, 4));
            this.#strokeColor_accessor_storage = (__runInitializers(this, _strokeWidth_extraInitializers), __runInitializers(this, _strokeColor_initializers, '--affine-palette-line-yellow'));
            ...
            this.#shapeStyle_accessor_storage = (__runInitializers(this, _strokeStyle_extraInitializers), __runInitializers(this, _shapeStyle_initializers, 'General'));
            this.#roughness_accessor_storage = (__runInitializers(this, _shapeStyle_extraInitializers), __runInitializers(this, _roughness_initializers, DEFAULT_ROUGHNESS));
            this.#text_accessor_storage = (__runInitializers(this, _roughness_extraInitializers), __runInitializers(this, _text_initializers, undefined));
            this.#color_accessor_storage = (__runInitializers(this, _text_extraInitializers), __runInitializers(this, _color_initializers, void 0));
            this.#fontSize_accessor_storage = (__runInitializers(this, _color_extraInitializers), __runInitializers(this, _fontSize_initializers, void 0));
            this.#fontFamily_accessor_storage = (__runInitializers(this, _fontSize_extraInitializers), __runInitializers(this, _fontFamily_initializers, void 0));
            this.#fontWeight_accessor_storage = (__runInitializers(this, _fontFamily_extraInitializers), __runInitializers(this, _fontWeight_initializers, void 0));
            this.#fontStyle_accessor_storage = (__runInitializers(this, _fontWeight_extraInitializers), __runInitializers(this, _fontStyle_initializers, void 0));
            this.#textAlign_accessor_storage = (__runInitializers(this, _fontStyle_extraInitializers), __runInitializers(this, _textAlign_initializers, void 0));
            this.#textHorizontalAlign_accessor_storage = (__runInitializers(this, _textAlign_extraInitializers), __runInitializers(this, _textHorizontalAlign_initializers, void 0));
            this.#textVerticalAlign_accessor_storage = (__runInitializers(this, _textHorizontalAlign_extraInitializers), __runInitializers(this, _textVerticalAlign_initializers, void 0));
            this.#textResizing_accessor_storage = (__runInitializers(this, _textVerticalAlign_extraInitializers), __runInitializers(this, _textResizing_initializers, TextResizing.AUTO_HEIGHT));
            this.#maxWidth_accessor_storage = (__runInitializers(this, _textResizing_extraInitializers), __runInitializers(this, _maxWidth_initializers, false));
            ...
            this.#shadow_accessor_storage = (__runInitializers(this, _padding_extraInitializers), __runInitializers(this, _shadow_initializers, null));
            this.textBound = (__runInitializers(this, _shadow_extraInitializers), null);
        }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _textDisplay_decorators = [local()];
            _xywh_decorators = [yfield()];
            _rotate_decorators = [yfield(0)];
            _shapeType_decorators = [yfield()];
            _radius_decorators = [yfield()];
            _filled_decorators = [yfield()];
            _fillColor_decorators = [yfield()];
            _strokeWidth_decorators = [yfield()];
            _strokeColor_decorators = [yfield()];
            _strokeStyle_decorators = [yfield()];
            _shapeStyle_decorators = [yfield('General')];
            _roughness_decorators = [yfield(DEFAULT_ROUGHNESS)];
            _text_decorators = [yfield()];
            _color_decorators = [yfield('#000000')];
            _fontSize_decorators = [yfield(ShapeTextFontSize.MEDIUM)];
            _fontFamily_decorators = [yfield(FontFamily.Inter)];
            _fontWeight_decorators = [yfield(FontWeight.Regular)];
            _fontStyle_decorators = [yfield(FontStyle.Normal)];
            _textAlign_decorators = [yfield(TextAlign.Center)];
            _textHorizontalAlign_decorators = [yfield(TextAlign.Center)];
            _textVerticalAlign_decorators = [yfield(TextVerticalAlign.Center)];
            _textResizing_decorators = [yfield(TextResizing.AUTO_HEIGHT)];
            _maxWidth_decorators = [yfield(false)];
            _padding_decorators = [yfield([SHAPE_TEXT_VERTICAL_PADDING, SHAPE_TEXT_PADDING])];
            _shadow_decorators = [yfield()];
