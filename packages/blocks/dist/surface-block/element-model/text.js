...
import { getPointsFromBoundsWithRotation, linePolygonIntersects, pointInPolygon, polygonNearestPoint, } from '../utils/math-utils.js';
...
let TextElementModel = (() => {
    ...
    return class TextElementModel extends _classSuper {
        static {
            ...
            _color_decorators = [yfield()];
            _fontSize_decorators = [yfield()];
            _fontFamily_decorators = [yfield()];
            _fontWeight_decorators = [yfield(FontWeight.Regular)];
            _fontStyle_decorators = [yfield(FontStyle.Normal)];
            _textAlign_decorators = [yfield()];
            _hasMaxWidth_decorators = [yfield(false)];
        ...
        #xywh_accessor_storage = __runInitializers(this, _xywh_initializers, '[0,0,16,16]');
        get xywh() { return this.#xywh_accessor_storage; }
        set xywh(value) { this.#xywh_accessor_storage = value; }
        #rotate_accessor_storage = (__runInitializers(this, _xywh_extraInitializers), __runInitializers(this, _rotate_initializers, 0));
        ...
        #color_accessor_storage = (__runInitializers(this, _text_extraInitializers), __runInitializers(this, _color_initializers, '#000000'));
        get color() { return this.#color_accessor_storage; }
        set color(value) { this.#color_accessor_storage = value; }
        #fontSize_accessor_storage = (__runInitializers(this, _color_extraInitializers), __runInitializers(this, _fontSize_initializers, 16));
        get fontSize() { return this.#fontSize_accessor_storage; }
        set fontSize(value) { this.#fontSize_accessor_storage = value; }
        #fontFamily_accessor_storage = (__runInitializers(this, _fontSize_extraInitializers), __runInitializers(this, _fontFamily_initializers, FontFamily.Inter));
        get fontFamily() { return this.#fontFamily_accessor_storage; }
        set fontFamily(value) { this.#fontFamily_accessor_storage = value; }
        #fontWeight_accessor_storage = (__runInitializers(this, _fontFamily_extraInitializers), __runInitializers(this, _fontWeight_initializers, FontWeight.Regular));
        get fontWeight() { return this.#fontWeight_accessor_storage; }
        set fontWeight(value) { this.#fontWeight_accessor_storage = value; }
        #fontStyle_accessor_storage = (__runInitializers(this, _fontWeight_extraInitializers), __runInitializers(this, _fontStyle_initializers, FontStyle.Normal));
        get fontStyle() { return this.#fontStyle_accessor_storage; }
        set fontStyle(value) { this.#fontStyle_accessor_storage = value; }
        #textAlign_accessor_storage = (__runInitializers(this, _fontStyle_extraInitializers), __runInitializers(this, _textAlign_initializers, TextAlign.Center));
        get textAlign() { return this.#textAlign_accessor_storage; }
        set textAlign(value) { this.#textAlign_accessor_storage = value; }
        #hasMaxWidth_accessor_storage = (__runInitializers(this, _textAlign_extraInitializers), __runInitializers(this, _hasMaxWidth_initializers, false));
        ...
        constructor() {
            super(...arguments);
            __runInitializers(this, _hasMaxWidth_extraInitializers);
        }
    };
})();
