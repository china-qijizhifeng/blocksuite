...
import { SurfaceElementModel, SurfaceLocalModel, } from './base.js';
...
let ConnectorElementModel = (() => {
    ...
    return class ConnectorElementModel extends _classSuper {
        static {
            ...
            _mode_decorators = [yfield()];
            _strokeWidth_decorators = [yfield()];
            _stroke_decorators = [yfield()];
            _strokeStyle_decorators = [yfield()];
            _roughness_decorators = [yfield()];
            _rough_decorators = [yfield()];
            _source_decorators = [yfield()];
            _target_decorators = [yfield()];
            _frontEndpointStyle_decorators = [yfield('None')];
            _rearEndpointStyle_decorators = [yfield('Arrow')];
            _text_decorators = [yfield()];
            _lableEditing_decorators = [local()];
            _labelDisplay_decorators = [yfield(true)];
            _labelXYWH_decorators = [yfield()];
            _labelOffset_decorators = [yfield({
                    distance: 0.5,
                    anchor: ConnectorLabelOffsetAnchor.Center,
                })];
            _labelStyle_decorators = [yfield({
                    color: '#000000',
            ...
            _labelConstraints_decorators = [yfield({
                    hasMaxWidth: true,
        ...
        hitTest(x, y, options) {
            ...
            if (this.labelHitTest(currentPoint)) {
                return true;
            }
        ...
        constructor() {
            super(...arguments);
            this.updatingPath = false;
            this.#path_accessor_storage = __runInitializers(this, _path_initializers, []);
            this.#absolutePath_accessor_storage = (__runInitializers(this, _path_extraInitializers), __runInitializers(this, _absolutePath_initializers, []));
            this.#xywh_accessor_storage = (__runInitializers(this, _absolutePath_extraInitializers), __runInitializers(this, _xywh_initializers, '[0,0,0,0]'));
            ...
            this.#mode_accessor_storage = (__runInitializers(this, _rotate_extraInitializers), __runInitializers(this, _mode_initializers, ConnectorMode.Orthogonal));
            this.#strokeWidth_accessor_storage = (__runInitializers(this, _mode_extraInitializers), __runInitializers(this, _strokeWidth_initializers, 4));
            this.#stroke_accessor_storage = (__runInitializers(this, _strokeWidth_extraInitializers), __runInitializers(this, _stroke_initializers, '#000000'));
            ...
            this.#roughness_accessor_storage = (__runInitializers(this, _strokeStyle_extraInitializers), __runInitializers(this, _roughness_initializers, DEFAULT_ROUGHNESS));
            this.#rough_accessor_storage = (__runInitializers(this, _roughness_extraInitializers), __runInitializers(this, _rough_initializers, undefined));
            this.#source_accessor_storage = (__runInitializers(this, _rough_extraInitializers), __runInitializers(this, _source_initializers, {
                position: [0, 0],
            }));
            this.#target_accessor_storage = (__runInitializers(this, _source_extraInitializers), __runInitializers(this, _target_initializers, {
                position: [0, 0],
            }));
            this.#frontEndpointStyle_accessor_storage = (__runInitializers(this, _target_extraInitializers), __runInitializers(this, _frontEndpointStyle_initializers, void 0));
            this.#rearEndpointStyle_accessor_storage = (__runInitializers(this, _frontEndpointStyle_extraInitializers), __runInitializers(this, _rearEndpointStyle_initializers, void 0));
            this.#text_accessor_storage = (__runInitializers(this, _rearEndpointStyle_extraInitializers), __runInitializers(this, _text_initializers, undefined));
            this.#lableEditing_accessor_storage = (__runInitializers(this, _text_extraInitializers), __runInitializers(this, _lableEditing_initializers, false));
            this.#labelDisplay_accessor_storage = (__runInitializers(this, _lableEditing_extraInitializers), __runInitializers(this, _labelDisplay_initializers, void 0));
            this.#labelXYWH_accessor_storage = (__runInitializers(this, _labelDisplay_extraInitializers), __runInitializers(this, _labelXYWH_initializers, undefined));
            this.#labelOffset_accessor_storage = (__runInitializers(this, _labelXYWH_extraInitializers), __runInitializers(this, _labelOffset_initializers, void 0));
            ...
            this.#labelConstraints_accessor_storage = (__runInitializers(this, _labelStyle_extraInitializers), __runInitializers(this, _labelConstraints_initializers, void 0));
            __runInitializers(this, _labelConstraints_extraInitializers);
        }
    };
})();
