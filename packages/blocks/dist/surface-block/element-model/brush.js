...
import { getPointsFromBoundsWithRotation, getQuadBoundsWithRotation, getSvgPathFromStroke, isPointOnlines, lineIntersects, polyLineNearestPoint, } from '../utils/math-utils.js';
...
let BrushElementModel = (() => {
    ...
    return class BrushElementModel extends _classSuper {
        ...
        #points_accessor_storage = __runInitializers(this, _points_initializers, []);
        get points() { return this.#points_accessor_storage; }
        set points(value) { this.#points_accessor_storage = value; }
        #xywh_accessor_storage = (__runInitializers(this, _points_extraInitializers), __runInitializers(this, _xywh_initializers, '[0,0,0,0]'));
        ...
        #color_accessor_storage = (__runInitializers(this, _rotate_extraInitializers), __runInitializers(this, _color_initializers, '#000000'));
        ...
        hitTest(px, py, options) {
            const hit = isPointOnlines(Bound.deserialize(this.xywh), this.points, this.rotate, [px, py], (options?.expand ?? 10) / Math.min(options?.zoom ?? 1, 1));
            return hit;
        }
        ...
        constructor() {
            super(...arguments);
            __runInitializers(this, _lineWidth_extraInitializers);
        }
    };
})();
