    ...
    constructor(manager) {
        ...
        this._onStdSelectionChanged = (selections) => {
            ...
            this.host.updateComplete
                ...
                const eq = text && this._prevTextSelection && path
        ...
        this._onNativeSelectionChanged = async () => {
            ...
            const isRangeReversed = !!selection.anchorNode &&
                !!selection.focusNode &&
        ...
        this._onCompositionStart = () => {
            ...
            const highestBlocks = this.rangeManager.getSelectedBlockElementsByRange(range, {
                mode: 'highest',
...
//# sourceMappingURL=range-binding.js.map