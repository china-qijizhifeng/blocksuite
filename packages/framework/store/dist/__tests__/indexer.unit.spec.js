...
function createTestDoc(pageId = 'doc:home', collection) {
...
describe('collection.search works', () => {
    it('collection search matching', () => {
        ...
        const text1 = '英特尔第13代酷睿i7-1370P移动处理器现身Geekbench，14核心和5GHz';
...
describe('backlink works', () => {
    ...
    it('backlink indexer works with linked doc', async () => {
        ...
        doc0.addBlock('affine:paragraph', {
        ...
        const paragraphId2 = doc0.addBlock('affine:paragraph', {
        ...
        doc1.addBlock('affine:paragraph', {
            text: doc1.Text.fromDelta([
                {
                    insert: ' ',
                    attributes: { reference: { type: 'LinkedPage', pageId: doc0.id } },
        ...
        const paragraphId4 = doc1.addBlock('affine:paragraph', {
            text: doc1.Text.fromDelta([
                {
                    insert: ' ',
                    attributes: { reference: { type: 'LinkedPage', pageId: doc1.id } },
...
//# sourceMappingURL=indexer.unit.spec.js.map