...
import { setupEdgelessCopilot, setupEdgelessElementToolbarEntry, } from './entries/edgeless/index.js';
...
export const AIPageRootBlockSpec = {
    ...PageRootBlockSpec,
    view: {
    ...
    setup: (slots, disposableGroup) => {
        ...
        disposableGroup.add(slots.widgetConnected.on(view => {
...
export const AIEdgelessRootBlockSpec = {
...
export const AIParagraphBlockSpec = {
    ...ParagraphBlockSpec,
    setup(slots, disposableGroup) {
