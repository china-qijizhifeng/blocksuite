...
let ActionMindmap = (() => {
    let _classDecorators = [customElement('action-mindmap')];
    ...
    var ActionMindmap = class extends _classSuper {
        ...
        static {
            ...
            ActionMindmap = _classThis = _classDescriptor.value;
    ...
    return ActionMindmap = _classThis;
})();
export { ActionMindmap };
