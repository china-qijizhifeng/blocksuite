...
let ActionImage = (() => {
    let _classDecorators = [customElement('action-image')];
    ...
    var ActionImage = class extends _classSuper {
        ...
        static {
            ...
            ActionImage = _classThis = _classDescriptor.value;
