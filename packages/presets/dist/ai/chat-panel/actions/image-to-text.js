...
let ActionImageToText = (() => {
    let _classDecorators = [customElement('action-image-to-text')];
    ...
    var ActionImageToText = class extends _classSuper {
        ...
        static {
            ...
            ActionImageToText = _classThis = _classDescriptor.value;
    ...
    return ActionImageToText = _classThis;
})();
export { ActionImageToText };
