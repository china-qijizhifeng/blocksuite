...
import { createVendor, FastImage2ImageServiceKind, Image2ImageServiceKind, Text2ImageServiceKind, } from './service-base.js';
...
export const createImageGenerator = (apiKey) => {
...
Image2ImageServiceKind.implService({
    ...
    method: ({ apiKey }) => ({
        generateImage: async (prompt, image) => {
            const data = await fetch('https://110602490-lcm-sd15-i2i.gateway.alpha.fal.ai/', {
                method: 'post',
                headers: {
