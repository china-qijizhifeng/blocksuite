...
export function runChangeToneAction({ input, tone, }) {
    return getChatService().chat([
        ...
        userText(input),
        userText(`Change the tone the of Markdown text to ${tone}, preserving the formatting, like bold, italic, link, highlight. Please be sure to only return the content.`),
    ]);
}
export function runFixSpellingAction(payload) {
    const { input } = payload;
    return getChatService().chat([
        {
            role: 'system',
        ...
        userText(input),
        userText('Fix the spelling and grammar of the text, preserving the markdown formatting, like bold, italic, link, highlight. Make sure to do your best'),
    ]);
}
export function runGenerateAction(payload) {
    const { input } = payload;
    return getChatService().chat([
        {
            role: 'system',
            content: 'You are assisting the user in extending the content of the whiteboard.',
        },
        userText(input),
        userText('Generate more content based on the current input.'),
    ]);
}
export function runImproveWritingAction(payload) {
    const { input } = payload;
    return getChatService().chat([
        {
            role: 'system',
        ...
        userText(input),
        userText('Improve the writing of the text, preserving the markdown formatting if needed, like bold, italic, link, highlight. Make sure to do your best'),
    ]);
}
export function runMakeLongerAction(payload) {
    const { input } = payload;
    return getChatService().chat([
        {
            role: 'system',
        ...
        userText(input),
        userText('Make the input text longer, preserving the markdown formatting, like bold, italic, link, highlight. Make sure to do your best'),
    ]);
}
export function runMakeShorterAction(payload) {
    const { input } = payload;
    return getChatService().chat([
        {
            role: 'system',
        ...
        userText(input),
        userText('Make the input text shorter, preserving the markdown formatting, like bold, italic, link, highlight. Make sure to do your best'),
    ]);
}
export function runRefineAction(payload) {
    const { input } = payload;
    return getChatService().chat([
        {
            role: 'system',
            content: 'You are assisting the user in refining the content of the whiteboard.',
        },
        userText(input),
        userText('Refine this text.'),
    ]);
}
export function runSimplifyWritingAction(payload) {
    const { input } = payload;
    return getChatService().chat([
        {
            role: 'system',
        ...
        userText(input),
        userText('Simplify the text, preserving the markdown formatting if needed, like bold, italic, link, highlight. Make sure to do your best'),
    ]);
}
export function runSummaryAction(payload) {
    const { input } = payload;
    return getChatService().chat([
        {
            role: 'system',
...
export function runTranslateAction(payload) {
    ...
    return getChatService().chat([
        ...
        userText(`Translate the Markdown text
...
export function runAnalysisAction(payload) {
    ...
    return getChatService().chat([
        ...payload.background,
        userText(`Use the nested unordered list syntax in Markdown to create a structure similar to a mind map. 
