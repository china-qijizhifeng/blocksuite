...
let FramesSettingMenu = (() => {
    ...
    return class FramesSettingMenu extends _classSuper {
        constructor() {
            super(...arguments);
            ...
            this.#blackBackground_accessor_storage = (__runInitializers(this, _editorHost_extraInitializers), __runInitializers(this, _blackBackground_initializers, false));
            this.#fillScreen_accessor_storage = (__runInitializers(this, _blackBackground_extraInitializers), __runInitializers(this, _fillScreen_initializers, false));
            ...
            this._onBlackBackgroundChange = (__runInitializers(this, _hideToolbar_extraInitializers), (checked) => {
            ...
            this._onFillScreenChange = (checked) => {
                ...
                this._rootService.editPropsStore.setItem('presentFillScreen', this.fillScreen);
            };
            this._onHideToolBarChange = (checked) => {
                ...
                this._rootService.editPropsStore.setItem('presentHideToolbar', this.hideToolbar);
            };
        }
        static {
