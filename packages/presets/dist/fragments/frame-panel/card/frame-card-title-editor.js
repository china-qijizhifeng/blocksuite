...
let FrameCardTitleEditor = (() => {
    ...
    return class FrameCardTitleEditor extends _classSuper {
        static {
        ...
        firstUpdated() {
            this.updateComplete
                ...
                this.disposables.addFromEvent(this.inlineEditorContainer, 'dblclick', e => {
                    e.stopPropagation();
                });
                this.disposables.addFromEvent(this.inlineEditorContainer, 'keydown', e => {
                    e.stopPropagation();
    ...
    ></rich-text>`;
        ...
        constructor() {
            ...
            this.#frameModel_accessor_storage = (__runInitializers(this, _richText_extraInitializers), __runInitializers(this, _frameModel_initializers, void 0));
            this.#titleContentElement_accessor_storage = (__runInitializers(this, _frameModel_extraInitializers), __runInitializers(this, _titleContentElement_initializers, void 0));
            this.#left_accessor_storage = (__runInitializers(this, _titleContentElement_extraInitializers), __runInitializers(this, _left_initializers, void 0));
            ...
            __runInitializers(this, _maxWidth_extraInitializers);
        }
    };
})();
