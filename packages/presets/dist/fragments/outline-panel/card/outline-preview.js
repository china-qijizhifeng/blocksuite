...
let OutlineBlockPreview = (() => {
    ...
    return class OutlineBlockPreview extends _classSuper {
        constructor() {
            ...
            this.#showPreviewIcon_accessor_storage = (__runInitializers(this, _block_extraInitializers), __runInitializers(this, _showPreviewIcon_initializers, void 0));
            ...
            this.#disabledIcon_accessor_storage = (__runInitializers(this, _enableNotesSorting_extraInitializers), __runInitializers(this, _disabledIcon_initializers, false));
            this.#cardNumber_accessor_storage = (__runInitializers(this, _disabledIcon_extraInitializers), __runInitializers(this, _cardNumber_initializers, void 0));
            this._clearTextDisposables = (__runInitializers(this, _cardNumber_extraInitializers), () => {
                this._textDisposables?.dispose();
                this._textDisposables = null;
            });
            this._setTextDisposables = (block) => {
      ...
      ${this.showPreviewIcon
        ...
        updated() {
            this.updateComplete
                .then(() => {
                if (BlocksUtils.matchFlavours(this.block, [
                    'affine:paragraph',
                    'affine:list',
                ])) {
        ...
        renderBlockByFlavour() {
            const { block } = this;
            const iconClass = this.disabledIcon ? 'icon disabled' : 'icon';
            const isHeadingBlock = BlocksUtils.matchFlavours(block, ['affine:paragraph']) &&
                headingKeys.has(block.type);
            if (!this.enableNotesSorting && !isHeadingBlock)
                return nothing;
