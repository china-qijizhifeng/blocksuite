...
let OutlinePanelBody = (() => {
    ...
    return class OutlinePanelBody extends _classSuper {
        ...
        _setDocDisposables() {
            ...
            slots.rootAdded.on(rootId => {
                ...
                this._docDisposables.add(root.childrenUpdated.on(() => {
                    this._updateNotes();
            ...
            slotsForUpdate.forEach(slot => {
                this._clearDocDisposables();
                this._docDisposables = new DisposableGroup();
                this._docDisposables.add(slot.on(() => {
                    this._updateNotes();
                    this._updateNoticeVisibility();
                }));
            });
        ...
        _updateNotes() {
            ...
            const pageVisibleNotes = [];
            const edgelessOnlyNotes = [];
        ...
        _scrollToBlock(e) {
            if (this._isEdgelessMode() || !this.editorHost)
                return;
            ...
            requestAnimationFrame(() => {
                ...
                const { top: offsetY, left: offsetX, scrollTop, scrollLeft, } = rootElement.viewport;
      ...
      ${withEdgelessOnlyNotes
            ...
            ${repeat(this._edgelessOnlyNotes, note => note.note.id, (note, idx) => html `<outline-note-card
                  data-note-id=${note.note.id}
                  .note=${note.note}
                  .number=${idx + 1}
                  .index=${note.index}
      ...
      <div class="note-placeholder">
        ...
        render() {
            ...
            const shouldRenderEdgelessOnlyNotes = this._shouldRenderNoteList(this._edgelessOnlyNotes);
    ...
    `;
        ...
        constructor() {
            ...
            this.#_pageVisibleNotes_accessor_storage = (__runInitializers(this, __dragging_extraInitializers), __runInitializers(this, __pageVisibleNotes_initializers, []));
            this.#_edgelessOnlyNotes_accessor_storage = (__runInitializers(this, __pageVisibleNotes_extraInitializers), __runInitializers(this, __edgelessOnlyNotes_initializers, []));
            this.#_selected_accessor_storage = (__runInitializers(this, __edgelessOnlyNotes_extraInitializers), __runInitializers(this, __selected_initializers, []));
            this._docDisposables = (__runInitializers(this, __selected_extraInitializers), null);
            ...
            this.#mode_accessor_storage = (__runInitializers(this, _editorHost_extraInitializers), __runInitializers(this, _mode_initializers, 'page'));
            this.#insertIndex_accessor_storage = (__runInitializers(this, _mode_extraInitializers), __runInitializers(this, _insertIndex_initializers, undefined));
            this.#showPreviewIcon_accessor_storage = (__runInitializers(this, _insertIndex_extraInitializers), __runInitializers(this, _showPreviewIcon_initializers, void 0));
            this.#enableNotesSorting_accessor_storage = (__runInitializers(this, _showPreviewIcon_extraInitializers), __runInitializers(this, _enableNotesSorting_initializers, void 0));
            this.#noticeVisible_accessor_storage = (__runInitializers(this, _enableNotesSorting_extraInitializers), __runInitializers(this, _noticeVisible_initializers, void 0));
            this.#toggleNotesSorting_accessor_storage = (__runInitializers(this, _noticeVisible_extraInitializers), __runInitializers(this, _toggleNotesSorting_initializers, void 0));
            this.#setNoticeVisibility_accessor_storage = (__runInitializers(this, _toggleNotesSorting_extraInitializers), __runInitializers(this, _setNoticeVisibility_initializers, void 0));
            this.#panelListElement_accessor_storage = (__runInitializers(this, _setNoticeVisibility_extraInitializers), __runInitializers(this, _panelListElement_initializers, void 0));
            this.#OutlinePanelContainer_accessor_storage = (__runInitializers(this, _panelListElement_extraInitializers), __runInitializers(this, _OutlinePanelContainer_initializers, void 0));
            this.#fitPadding_accessor_storage = (__runInitializers(this, _OutlinePanelContainer_extraInitializers), __runInitializers(this, _fitPadding_initializers, void 0));
            this.#domHost_accessor_storage = (__runInitializers(this, _fitPadding_extraInitializers), __runInitializers(this, _domHost_initializers, void 0));
            __runInitializers(this, _domHost_extraInitializers);
        }
    };
})();
