...
noop(EditorHost);
let EdgelessEditor = (() => {
    let _classDecorators = [customElement('edgeless-editor')];
  ...
  `; }
    ...
    `;
        ...
        constructor() {
            ...
            this.#specs_accessor_storage = (__runInitializers(this, _doc_extraInitializers), __runInitializers(this, _specs_initializers, EdgelessEditorBlockSpecs));
...
//# sourceMappingURL=edgeless-editor.js.map